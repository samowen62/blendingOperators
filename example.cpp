...
int main (int argc, char* argv[])
{
	...
	if(LoadShader("shaders/Shader1.vert", "shaders/Shader1.frag", false, false, true, ShaderProgram[0], VertexShader[0], FragmentShader[0])==-1)
	{
		exit(1);
	}
	else
	...
	if(LoadShader("shaders/Shader2.vert", "shaders/Shader2.frag", true, true, false, ShaderProgram[1], VertexShader[1], FragmentShader[1])==-1)
	{
		exit(1);
	}
	else
